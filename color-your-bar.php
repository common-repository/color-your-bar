...
if ( has_action( 'amp_post_template_head' )) {
	add_action( 'amp_post_template_head', 'cyb_add_head_tag' );
}
...
function cyb_add_head_tag(){
	...
	<meta name="theme-color" content="<?php echo esc_attr( $cyb_color ); ?>" media="(prefers-color-scheme: light)">
	<meta name="theme-color" content="<?php echo esc_attr( $cyb_color ); ?>" media="(prefers-color-scheme: dark)">
<?php }
